  ...
  return (
    <div>
      ...
      <div
        ...
        className="border-2 border-[#eee] w-full flex items-start justify-around   active:border-2 active:border-[#000000] rounded-lg relative  px-10 py-3"
      >
        <img
          className="h-20 w-20"
        ...
        <div className=" ">
          <h4 className="text-2xl font-medium">
            UberGo{" "}
            <span className="text-lg absolute top-16 right-2 font-normal ml-3">
        ...
        <h2 className=" w-[2%] font-extrabold  text-2xl flex absolute right-18"> ${fare.car}</h2>
      </div>
      <div
        onClick={() => {
          setconfirmvehiclepanel(true),
        ...
        className="border-2 border-[#eee] w-full flex items-start justify-around mt-2  active:border-2 active:border-[#000000] rounded-lg relative  px-10 py-3"
      >
        <img
          className="h-20 w-20"
        ...
        <h2 className="w-[2%] font-extrabold  text-2xl absolute right-15">${fare.motorcycle}</h2>
      </div>
      <div
        onClick={() => {
          setconfirmvehiclepanel(true),
        ...
        className="mt-2 border-2 border-[#eee] w-full flex items-start justify-around   active:border-2 active:border-[#000000] relative rounded-lg  px-10 py-3"
      >
        <img
          className="h-15 w-20"
        ...
        <div className="  ">
          <h4 className="text-2xl font-medium">
            Uber Auto{" "}
            <span className="text-lg font-normal absolute top-16 right-2 ml-3">
              <i className="ri-group-fill text-lg"></i>4
            </span>{" "}
          </h4>
          <h5>1 min away ..</h5>
        ...
        <h2 className=" w-[2%] font-extrabold text-2xl absolute right-13 ">${fare.auto}</h2>
      </div>
      </div>
  );
};
