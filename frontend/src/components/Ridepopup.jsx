...
const Ridepopup = ({setRidePopup, setconfirmride}) => {
  return (
    <div>
      <div className="relative">
        ...
        <div className="h-90 w-[80%] bg-[#f3efef] mt-8 ml-10 border rounded-lg shadow-lg">
            ...
            <div className="buttona h-12 w-[90%] mt-5 ml-5 flex items-center">
                ...
                <button onClick={()=>{setconfirmride(true)}}  className="ml-5 bg-yellow-500 p-2 w-1/2 rounded-lg font-bold">Accept</button>
            </div>
        </div>
