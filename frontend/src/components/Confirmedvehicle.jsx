...
const Confirmedvehicle = ({setconfirmvehiclepanel, setlookingfordriver}) => {
  return (
    <div className="relative ">
      <h5 onClick={()=>{setconfirmvehiclepanel(false)}} className="absolute top-3 right-0">
      ...
      <div   className="absolute top-104 flex ml-20 gap-2 mt-0  border-2 border-gray-100 rounded-lg active:border-black justify-center items-center w-[75%] bg-green-700"><button onClick={()=>{setlookingfordriver(true)}} className="p-5 mt-0 text-white font-bold text-xl">Confirm your ride</button></div>
